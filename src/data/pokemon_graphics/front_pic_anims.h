...
PLACEHOLDER_ANIM_SINGLE_FRAME(Spark);
PLACEHOLDER_ANIM_SINGLE_FRAME(Sparkape);
PLACEHOLDER_ANIM_SINGLE_FRAME(Sparkong);
static const union AnimCmd sAnim_Thunderback_1[] =
{
    ANIMCMD_FRAME(0, 10),
    ANIMCMD_FRAME(1, 15),
    ANIMCMD_FRAME(0, 15),
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Brakie);
PLACEHOLDER_ANIM_SINGLE_FRAME(Brakio);
PLACEHOLDER_ANIM_SINGLE_FRAME(Brakion);
static const union AnimCmd sAnim_Brakitorus_1[] =
{
    ANIMCMD_FRAME(0, 10),
    ANIMCMD_FRAME(1, 15),
    ANIMCMD_FRAME(0, 15),
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Snorkling);
PLACEHOLDER_ANIM_SINGLE_FRAME(Blazenort);
PLACEHOLDER_ANIM_SINGLE_FRAME(Hogfire);
PLACEHOLDER_ANIM_SINGLE_FRAME(Soltusk);
PLACEHOLDER_ANIM_SINGLE_FRAME(Frostkit);
PLACEHOLDER_ANIM_SINGLE_FRAME(Frostbite);
PLACEHOLDER_ANIM_SINGLE_FRAME(Blizzkat);
PLACEHOLDER_ANIM_SINGLE_FRAME(Glazio);
PLACEHOLDER_ANIM_SINGLE_FRAME(Gustbat);
PLACEHOLDER_ANIM_SINGLE_FRAME(Galebat);
PLACEHOLDER_ANIM_SINGLE_FRAME(Plasmo);
PLACEHOLDER_ANIM_SINGLE_FRAME(Plasmodious);
PLACEHOLDER_ANIM_SINGLE_FRAME(Fireworker);
PLACEHOLDER_ANIM_SINGLE_FRAME(Firesoldier);
PLACEHOLDER_ANIM_SINGLE_FRAME(Firequeen);
PLACEHOLDER_ANIM_SINGLE_FRAME(Sanders);
PLACEHOLDER_ANIM_SINGLE_FRAME(Kentucky);
PLACEHOLDER_ANIM_SINGLE_FRAME(Seaquill);
PLACEHOLDER_ANIM_SINGLE_FRAME(Seaspine);
PLACEHOLDER_ANIM_SINGLE_FRAME(Bluechick);
PLACEHOLDER_ANIM_SINGLE_FRAME(Bluetail);
PLACEHOLDER_ANIM_SINGLE_FRAME(Goldlamb);
PLACEHOLDER_ANIM_SINGLE_FRAME(Goldfleece);
PLACEHOLDER_ANIM_SINGLE_FRAME(Goldram);
PLACEHOLDER_ANIM_SINGLE_FRAME(Bitefish);
PLACEHOLDER_ANIM_SINGLE_FRAME(Biteschool);
PLACEHOLDER_ANIM_SINGLE_FRAME(Seedtooth);
PLACEHOLDER_ANIM_SINGLE_FRAME(Leaftooth);
PLACEHOLDER_ANIM_SINGLE_FRAME(Shrubtooth);
PLACEHOLDER_ANIM_SINGLE_FRAME(Bronzeshell);
PLACEHOLDER_ANIM_SINGLE_FRAME(Breezeling);
PLACEHOLDER_ANIM_SINGLE_FRAME(Breezekite);
PLACEHOLDER_ANIM_SINGLE_FRAME(Breezehawk);
PLACEHOLDER_ANIM_SINGLE_FRAME(Glaucoal);
PLACEHOLDER_ANIM_SINGLE_FRAME(Glaukindle);
PLACEHOLDER_ANIM_SINGLE_FRAME(Fang);
PLACEHOLDER_ANIM_SINGLE_FRAME(Lobo);
PLACEHOLDER_ANIM_SINGLE_FRAME(Remus);
PLACEHOLDER_ANIM_SINGLE_FRAME(Spooky);
PLACEHOLDER_ANIM_SINGLE_FRAME(Spooker);
PLACEHOLDER_ANIM_SINGLE_FRAME(Snowfawn);
PLACEHOLDER_ANIM_SINGLE_FRAME(Snowhorn);
PLACEHOLDER_ANIM_SINGLE_FRAME(Snowstag);
PLACEHOLDER_ANIM_SINGLE_FRAME(Bullhorn);
PLACEHOLDER_ANIM_SINGLE_FRAME(Bosshorn);
PLACEHOLDER_ANIM_SINGLE_FRAME(Narpike);
PLACEHOLDER_ANIM_SINGLE_FRAME(Narpoon);
PLACEHOLDER_ANIM_SINGLE_FRAME(Narlance);
PLACEHOLDER_ANIM_SINGLE_FRAME(Squirehawk);
PLACEHOLDER_ANIM_SINGLE_FRAME(Knighthawk);
PLACEHOLDER_ANIM_SINGLE_FRAME(Mantisword);
PLACEHOLDER_ANIM_SINGLE_FRAME(Pengboy);
PLACEHOLDER_ANIM_SINGLE_FRAME(Pengster);
PLACEHOLDER_ANIM_SINGLE_FRAME(Pengboss);
PLACEHOLDER_ANIM_SINGLE_FRAME(Jabby);
PLACEHOLDER_ANIM_SINGLE_FRAME(Jabbit);
PLACEHOLDER_ANIM_SINGLE_FRAME(Sphinxcat);
PLACEHOLDER_ANIM_SINGLE_FRAME(Pharaohcat);
PLACEHOLDER_ANIM_SINGLE_FRAME(Chillbear);
PLACEHOLDER_ANIM_SINGLE_FRAME(Icebear);
PLACEHOLDER_ANIM_SINGLE_FRAME(Freezebear);
PLACEHOLDER_ANIM_SINGLE_FRAME(Smokepup);
PLACEHOLDER_ANIM_SINGLE_FRAME(Firewolf);
PLACEHOLDER_ANIM_SINGLE_FRAME(Beowolf);
PLACEHOLDER_ANIM_SINGLE_FRAME(Hedgehot);
PLACEHOLDER_ANIM_SINGLE_FRAME(Hedgeheat);
PLACEHOLDER_ANIM_SINGLE_FRAME(Stegy);
PLACEHOLDER_ANIM_SINGLE_FRAME(Stegodon);
PLACEHOLDER_ANIM_SINGLE_FRAME(Stegotops);
PLACEHOLDER_ANIM_SINGLE_FRAME(Frostjack);
PLACEHOLDER_ANIM_SINGLE_FRAME(Frostknight);
PLACEHOLDER_ANIM_SINGLE_FRAME(Flarerunner);
PLACEHOLDER_ANIM_SINGLE_FRAME(Flamerunner);
PLACEHOLDER_ANIM_SINGLE_FRAME(Blazerunner);
PLACEHOLDER_ANIM_SINGLE_FRAME(Bladeshark);
PLACEHOLDER_ANIM_SINGLE_FRAME(Sabreshark);
PLACEHOLDER_ANIM_SINGLE_FRAME(Clubby);
PLACEHOLDER_ANIM_SINGLE_FRAME(Bouldon);
PLACEHOLDER_ANIM_SINGLE_FRAME(Duskling);
PLACEHOLDER_ANIM_SINGLE_FRAME(Duskhawk);
PLACEHOLDER_ANIM_SINGLE_FRAME(Duskroc);
PLACEHOLDER_ANIM_SINGLE_FRAME(Dullakid);
PLACEHOLDER_ANIM_SINGLE_FRAME(Dullahan);
PLACEHOLDER_ANIM_SINGLE_FRAME(Dullakhan);
PLACEHOLDER_ANIM_SINGLE_FRAME(Squallfox);
PLACEHOLDER_ANIM_SINGLE_FRAME(Thunderfox);
PLACEHOLDER_ANIM_SINGLE_FRAME(Stormfox);
PLACEHOLDER_ANIM_SINGLE_FRAME(Seabite);
PLACEHOLDER_ANIM_SINGLE_FRAME(Seadile);
PLACEHOLDER_ANIM_SINGLE_FRAME(Searex);
PLACEHOLDER_ANIM_SINGLE_FRAME(Moby);
PLACEHOLDER_ANIM_SINGLE_FRAME(Rockfin);
PLACEHOLDER_ANIM_SINGLE_FRAME(Tidalwhale);
PLACEHOLDER_ANIM_SINGLE_FRAME(Torchtail);
PLACEHOLDER_ANIM_SINGLE_FRAME(Scorchtail);
PLACEHOLDER_ANIM_SINGLE_FRAME(Musharoo);
PLACEHOLDER_ANIM_SINGLE_FRAME(Wooly);
PLACEHOLDER_ANIM_SINGLE_FRAME(Mammut);
PLACEHOLDER_ANIM_SINGLE_FRAME(Rockoid);
PLACEHOLDER_ANIM_SINGLE_FRAME(Dynabird);
PLACEHOLDER_ANIM_SINGLE_FRAME(Nitrobird);
PLACEHOLDER_ANIM_SINGLE_FRAME(Flamewing);
PLACEHOLDER_ANIM_SINGLE_FRAME(Blazewing);
PLACEHOLDER_ANIM_SINGLE_FRAME(Pteroling);
PLACEHOLDER_ANIM_SINGLE_FRAME(Pterosoar);
PLACEHOLDER_ANIM_SINGLE_FRAME(Gremly);
PLACEHOLDER_ANIM_SINGLE_FRAME(Gremknight);
PLACEHOLDER_ANIM_SINGLE_FRAME(Voltyke);
PLACEHOLDER_ANIM_SINGLE_FRAME(Voltooth);
PLACEHOLDER_ANIM_SINGLE_FRAME(Voltiger);
PLACEHOLDER_ANIM_SINGLE_FRAME(Miniceros);
PLACEHOLDER_ANIM_SINGLE_FRAME(Geoceros);
PLACEHOLDER_ANIM_SINGLE_FRAME(Gigaceros);
PLACEHOLDER_ANIM_SINGLE_FRAME(Prickly);
PLACEHOLDER_ANIM_SINGLE_FRAME(Prickster);
PLACEHOLDER_ANIM_SINGLE_FRAME(Grizzie);
PLACEHOLDER_ANIM_SINGLE_FRAME(Grizzpunk);
PLACEHOLDER_ANIM_SINGLE_FRAME(Grizzrex);
PLACEHOLDER_ANIM_SINGLE_FRAME(Flamogaru);
PLACEHOLDER_ANIM_SINGLE_FRAME(Flamurai);
PLACEHOLDER_ANIM_SINGLE_FRAME(Flamogun);
PLACEHOLDER_ANIM_SINGLE_FRAME(Orcan);
PLACEHOLDER_ANIM_SINGLE_FRAME(Orcoid);
PLACEHOLDER_ANIM_SINGLE_FRAME(Flama);
PLACEHOLDER_ANIM_SINGLE_FRAME(Solama);
PLACEHOLDER_ANIM_SINGLE_FRAME(Joustfish);
PLACEHOLDER_ANIM_SINGLE_FRAME(Marspin);
PLACEHOLDER_ANIM_SINGLE_FRAME(Rexy);
PLACEHOLDER_ANIM_SINGLE_FRAME(Georex);
PLACEHOLDER_ANIM_SINGLE_FRAME(Pearex);
PLACEHOLDER_ANIM_SINGLE_FRAME(Raptorex);
PLACEHOLDER_ANIM_SINGLE_FRAME(Levi);
PLACEHOLDER_ANIM_SINGLE_FRAME(Leviathan);
PLACEHOLDER_ANIM_SINGLE_FRAME(Sizzler);
PLACEHOLDER_ANIM_SINGLE_FRAME(Pyroviper);
PLACEHOLDER_ANIM_SINGLE_FRAME(Tinder);
PLACEHOLDER_ANIM_SINGLE_FRAME(Firemane);
PLACEHOLDER_ANIM_SINGLE_FRAME(Fireheart);
PLACEHOLDER_ANIM_SINGLE_FRAME(Halocat);
PLACEHOLDER_ANIM_SINGLE_FRAME(Halopard);
PLACEHOLDER_ANIM_SINGLE_FRAME(Moogong);
PLACEHOLDER_ANIM_SINGLE_FRAME(Tombguard);
PLACEHOLDER_ANIM_SINGLE_FRAME(Chopperbug);
PLACEHOLDER_ANIM_SINGLE_FRAME(Nightfoal);
PLACEHOLDER_ANIM_SINGLE_FRAME(Nightmare);
PLACEHOLDER_ANIM_SINGLE_FRAME(Gargol);
PLACEHOLDER_ANIM_SINGLE_FRAME(Nilo);
PLACEHOLDER_ANIM_SINGLE_FRAME(Nilos);
PLACEHOLDER_ANIM_SINGLE_FRAME(Nilox);
PLACEHOLDER_ANIM_SINGLE_FRAME(Nilomoth);
PLACEHOLDER_ANIM_SINGLE_FRAME(Metallo);
PLACEHOLDER_ANIM_SINGLE_FRAME(Metallodious);
PLACEHOLDER_ANIM_SINGLE_FRAME(Cherub);
PLACEHOLDER_ANIM_SINGLE_FRAME(Cherubion);
PLACEHOLDER_ANIM_SINGLE_FRAME(Luxknight);
PLACEHOLDER_ANIM_SINGLE_FRAME(Skullwraith);
PLACEHOLDER_ANIM_SINGLE_FRAME(Shadowlance);
PLACEHOLDER_ANIM_SINGLE_FRAME(Prometheo);
PLACEHOLDER_ANIM_SINGLE_FRAME(Inferneo);
PLACEHOLDER_ANIM_SINGLE_FRAME(Yetigo);
PLACEHOLDER_ANIM_SINGLE_FRAME(Sanctolamb);
PLACEHOLDER_ANIM_SINGLE_FRAME(Blockadus);
PLACEHOLDER_ANIM_SINGLE_FRAME(Barricadus);
PLACEHOLDER_ANIM_SINGLE_FRAME(Raioh);
PLACEHOLDER_ANIM_SINGLE_FRAME(Raijin);
PLACEHOLDER_ANIM_SINGLE_FRAME(Skullrex);
PLACEHOLDER_ANIM_SINGLE_FRAME(Galey);
PLACEHOLDER_ANIM_SINGLE_FRAME(Skywing);
PLACEHOLDER_ANIM_SINGLE_FRAME(Aerowing);
PLACEHOLDER_ANIM_SINGLE_FRAME(Ventowyrm);
PLACEHOLDER_ANIM_SINGLE_FRAME(Bluey);
PLACEHOLDER_ANIM_SINGLE_FRAME(Bluewing);
PLACEHOLDER_ANIM_SINGLE_FRAME(Aquawing);
PLACEHOLDER_ANIM_SINGLE_FRAME(Hydrowyrm);
PLACEHOLDER_ANIM_SINGLE_FRAME(Ashie);
PLACEHOLDER_ANIM_SINGLE_FRAME(Ashwing);
PLACEHOLDER_ANIM_SINGLE_FRAME(Scorchwing);
PLACEHOLDER_ANIM_SINGLE_FRAME(Pyrowyrm);
PLACEHOLDER_ANIM_SINGLE_FRAME(Leafy);
PLACEHOLDER_ANIM_SINGLE_FRAME(Leafwing);
PLACEHOLDER_ANIM_SINGLE_FRAME(Greenwing);
PLACEHOLDER_ANIM_SINGLE_FRAME(Gaiawyrm);
PLACEHOLDER_ANIM_SINGLE_FRAME(Bearfist);
PLACEHOLDER_ANIM_SINGLE_FRAME(Flamorider);
PLACEHOLDER_ANIM_SINGLE_FRAME(Orcow);
PLACEHOLDER_ANIM_SINGLE_FRAME(Mechadino);
PLACEHOLDER_ANIM_SINGLE_FRAME(Skywolf);
PLACEHOLDER_ANIM_SINGLE_FRAME(Angelon);
PLACEHOLDER_ANIM_SINGLE_FRAME(Plasmorex);
PLACEHOLDER_ANIM_SINGLE_FRAME(Tremorback);
PLACEHOLDER_ANIM_SINGLE_FRAME(Dreadwolf);
PLACEHOLDER_ANIM_SINGLE_FRAME(Magmawyrm);
PLACEHOLDER_ANIM_SINGLE_FRAME(Typhonwyrm);
PLACEHOLDER_ANIM_SINGLE_FRAME(Omegawyrm);
PLACEHOLDER_ANIM_SINGLE_FRAME(Halochron);
PLACEHOLDER_ANIM_SINGLE_FRAME(Guardiron);
PLACEHOLDER_ANIM_SINGLE_FRAME(Deletroid);
PLACEHOLDER_ANIM_SINGLE_FRAME(Destructor);
PLACEHOLDER_ANIM_SINGLE_FRAME(Samurice);
PLACEHOLDER_ANIM_SINGLE_FRAME(Snowja);
PLACEHOLDER_ANIM_SINGLE_FRAME(Vegikit);
PLACEHOLDER_ANIM_SINGLE_FRAME(Vegilynx);
PLACEHOLDER_ANIM_SINGLE_FRAME(Vegitiger);
PLACEHOLDER_ANIM_SINGLE_FRAME(Minispine);
PLACEHOLDER_ANIM_SINGLE_FRAME(Stegospine);
PLACEHOLDER_ANIM_SINGLE_FRAME(Stegospike);
PLACEHOLDER_ANIM_SINGLE_FRAME(Shadowkit);
PLACEHOLDER_ANIM_SINGLE_FRAME(Shadowstalker);
PLACEHOLDER_ANIM_SINGLE_FRAME(Mandrapod);
PLACEHOLDER_ANIM_SINGLE_FRAME(Mandroot);
PLACEHOLDER_ANIM_SINGLE_FRAME(Darkpaw);
PLACEHOLDER_ANIM_SINGLE_FRAME(Bloodclaw);
PLACEHOLDER_ANIM_SINGLE_FRAME(Pegahoof);
PLACEHOLDER_ANIM_SINGLE_FRAME(Pegasion);
PLACEHOLDER_ANIM_SINGLE_FRAME(Orbling);
PLACEHOLDER_ANIM_SINGLE_FRAME(Kamiwyrm);
PLACEHOLDER_ANIM_SINGLE_FRAME(Scorpiode);
PLACEHOLDER_ANIM_SINGLE_FRAME(Scorpionix);
PLACEHOLDER_ANIM_SINGLE_FRAME(Golgem);
PLACEHOLDER_ANIM_SINGLE_FRAME(Golgemios);
PLACEHOLDER_ANIM_SINGLE_FRAME(Cyberhound);
PLACEHOLDER_ANIM_SINGLE_FRAME(Cyberwyrm);
PLACEHOLDER_ANIM_SINGLE_FRAME(Spinoheat);
PLACEHOLDER_ANIM_SINGLE_FRAME(Spinoburn);
PLACEHOLDER_ANIM_SINGLE_FRAME(Spinoflame);
PLACEHOLDER_ANIM_SINGLE_FRAME(Hadepup);
PLACEHOLDER_ANIM_SINGLE_FRAME(Hadehound);
PLACEHOLDER_ANIM_SINGLE_FRAME(Cryptwing);
PLACEHOLDER_ANIM_SINGLE_FRAME(Osiriswyrm);
PLACEHOLDER_ANIM_SINGLE_FRAME(Arky);
PLACEHOLDER_ANIM_SINGLE_FRAME(Arkwing);
PLACEHOLDER_ANIM_SINGLE_FRAME(Darkling);
PLACEHOLDER_ANIM_SINGLE_FRAME(Necrodrake);
PLACEHOLDER_ANIM_SINGLE_FRAME(Zephys);
PLACEHOLDER_ANIM_SINGLE_FRAME(Arborus);
PLACEHOLDER_ANIM_SINGLE_FRAME(Dahag);
PLACEHOLDER_ANIM_SINGLE_FRAME(Vulcarex);
PLACEHOLDER_ANIM_SINGLE_FRAME(Esapid);
PLACEHOLDER_ANIM_SINGLE_FRAME(Deucalion);
PLACEHOLDER_ANIM_SINGLE_FRAME(Tiamat);
...
#endif //P_FAMILY_PECHARUNT
SINGLE_ANIMATION(Spark);
SINGLE_ANIMATION(Sparkape);
SINGLE_ANIMATION(Sparkong);
SINGLE_ANIMATION(Thunderback);
SINGLE_ANIMATION(Brakie);
SINGLE_ANIMATION(Brakio);
SINGLE_ANIMATION(Brakion);
SINGLE_ANIMATION(Brakitorus);
SINGLE_ANIMATION(Snorkling);
SINGLE_ANIMATION(Blazenort);
SINGLE_ANIMATION(Hogfire);
SINGLE_ANIMATION(Soltusk);
SINGLE_ANIMATION(Frostkit);
SINGLE_ANIMATION(Frostbite);
SINGLE_ANIMATION(Blizzkat);
SINGLE_ANIMATION(Glazio);
SINGLE_ANIMATION(Gustbat);
SINGLE_ANIMATION(Galebat);
SINGLE_ANIMATION(Plasmo);
SINGLE_ANIMATION(Plasmodious);
SINGLE_ANIMATION(Fireworker);
SINGLE_ANIMATION(Firesoldier);
SINGLE_ANIMATION(Firequeen);
SINGLE_ANIMATION(Sanders);
SINGLE_ANIMATION(Kentucky);
SINGLE_ANIMATION(Seaquill);
SINGLE_ANIMATION(Seaspine);
SINGLE_ANIMATION(Bluechick);
SINGLE_ANIMATION(Bluetail);
SINGLE_ANIMATION(Goldlamb);
SINGLE_ANIMATION(Goldfleece);
SINGLE_ANIMATION(Goldram);
SINGLE_ANIMATION(Bitefish);
SINGLE_ANIMATION(Biteschool);
SINGLE_ANIMATION(Seedtooth);
SINGLE_ANIMATION(Leaftooth);
SINGLE_ANIMATION(Shrubtooth);
SINGLE_ANIMATION(Bronzeshell);
SINGLE_ANIMATION(Breezeling);
SINGLE_ANIMATION(Breezekite);
SINGLE_ANIMATION(Breezehawk);
SINGLE_ANIMATION(Glaucoal);
SINGLE_ANIMATION(Glaukindle);
SINGLE_ANIMATION(Fang);
SINGLE_ANIMATION(Lobo);
SINGLE_ANIMATION(Remus);
SINGLE_ANIMATION(Spooky);
SINGLE_ANIMATION(Spooker);
SINGLE_ANIMATION(Snowfawn);
SINGLE_ANIMATION(Snowhorn);
SINGLE_ANIMATION(Snowstag);
SINGLE_ANIMATION(Bullhorn);
SINGLE_ANIMATION(Bosshorn);
SINGLE_ANIMATION(Narpike);
SINGLE_ANIMATION(Narpoon);
SINGLE_ANIMATION(Narlance);
SINGLE_ANIMATION(Squirehawk);
SINGLE_ANIMATION(Knighthawk);
SINGLE_ANIMATION(Mantisword);
SINGLE_ANIMATION(Pengboy);
SINGLE_ANIMATION(Pengster);
SINGLE_ANIMATION(Pengboss);
SINGLE_ANIMATION(Jabby);
SINGLE_ANIMATION(Jabbit);
SINGLE_ANIMATION(Sphinxcat);
SINGLE_ANIMATION(Pharaohcat);
SINGLE_ANIMATION(Chillbear);
SINGLE_ANIMATION(Icebear);
SINGLE_ANIMATION(Freezebear);
SINGLE_ANIMATION(Smokepup);
SINGLE_ANIMATION(Firewolf);
SINGLE_ANIMATION(Beowolf);
SINGLE_ANIMATION(Hedgehot);
SINGLE_ANIMATION(Hedgeheat);
SINGLE_ANIMATION(Stegy);
SINGLE_ANIMATION(Stegodon);
SINGLE_ANIMATION(Stegotops);
SINGLE_ANIMATION(Frostjack);
SINGLE_ANIMATION(Frostknight);
SINGLE_ANIMATION(Flarerunner);
SINGLE_ANIMATION(Flamerunner);
SINGLE_ANIMATION(Blazerunner);
SINGLE_ANIMATION(Bladeshark);
SINGLE_ANIMATION(Sabreshark);
SINGLE_ANIMATION(Clubby);
SINGLE_ANIMATION(Bouldon);
SINGLE_ANIMATION(Duskling);
SINGLE_ANIMATION(Duskhawk);
SINGLE_ANIMATION(Duskroc);
SINGLE_ANIMATION(Dullakid);
SINGLE_ANIMATION(Dullahan);
SINGLE_ANIMATION(Dullakhan);
SINGLE_ANIMATION(Squallfox);
SINGLE_ANIMATION(Thunderfox);
SINGLE_ANIMATION(Stormfox);
SINGLE_ANIMATION(Seabite);
SINGLE_ANIMATION(Seadile);
SINGLE_ANIMATION(Searex);
SINGLE_ANIMATION(Moby);
SINGLE_ANIMATION(Rockfin);
SINGLE_ANIMATION(Tidalwhale);
SINGLE_ANIMATION(Torchtail);
SINGLE_ANIMATION(Scorchtail);
SINGLE_ANIMATION(Musharoo);
SINGLE_ANIMATION(Wooly);
SINGLE_ANIMATION(Mammut);
SINGLE_ANIMATION(Rockoid);
SINGLE_ANIMATION(Dynabird);
SINGLE_ANIMATION(Nitrobird);
SINGLE_ANIMATION(Flamewing);
SINGLE_ANIMATION(Blazewing);
SINGLE_ANIMATION(Pteroling);
SINGLE_ANIMATION(Pterosoar);
SINGLE_ANIMATION(Gremly);
SINGLE_ANIMATION(Gremknight);
SINGLE_ANIMATION(Voltyke);
SINGLE_ANIMATION(Voltooth);
SINGLE_ANIMATION(Voltiger);
SINGLE_ANIMATION(Miniceros);
SINGLE_ANIMATION(Geoceros);
SINGLE_ANIMATION(Gigaceros);
SINGLE_ANIMATION(Prickly);
SINGLE_ANIMATION(Prickster);
SINGLE_ANIMATION(Grizzie);
SINGLE_ANIMATION(Grizzpunk);
SINGLE_ANIMATION(Grizzrex);
SINGLE_ANIMATION(Flamogaru);
SINGLE_ANIMATION(Flamurai);
SINGLE_ANIMATION(Flamogun);
SINGLE_ANIMATION(Orcan);
SINGLE_ANIMATION(Orcoid);
SINGLE_ANIMATION(Flama);
SINGLE_ANIMATION(Solama);
SINGLE_ANIMATION(Joustfish);
SINGLE_ANIMATION(Marspin);
SINGLE_ANIMATION(Rexy);
SINGLE_ANIMATION(Georex);
SINGLE_ANIMATION(Pearex);
SINGLE_ANIMATION(Raptorex);
SINGLE_ANIMATION(Levi);
SINGLE_ANIMATION(Leviathan);
SINGLE_ANIMATION(Sizzler);
SINGLE_ANIMATION(Pyroviper);
SINGLE_ANIMATION(Tinder);
SINGLE_ANIMATION(Firemane);
SINGLE_ANIMATION(Fireheart);
SINGLE_ANIMATION(Halocat);
SINGLE_ANIMATION(Halopard);
SINGLE_ANIMATION(Moogong);
SINGLE_ANIMATION(Tombguard);
SINGLE_ANIMATION(Chopperbug);
SINGLE_ANIMATION(Nightfoal);
SINGLE_ANIMATION(Nightmare);
SINGLE_ANIMATION(Gargol);
SINGLE_ANIMATION(Nilo);
SINGLE_ANIMATION(Nilos);
SINGLE_ANIMATION(Nilox);
SINGLE_ANIMATION(Nilomoth);
SINGLE_ANIMATION(Metallo);
SINGLE_ANIMATION(Metallodious);
SINGLE_ANIMATION(Cherub);
SINGLE_ANIMATION(Cherubion);
SINGLE_ANIMATION(Luxknight);
SINGLE_ANIMATION(Skullwraith);
SINGLE_ANIMATION(Shadowlance);
SINGLE_ANIMATION(Prometheo);
SINGLE_ANIMATION(Inferneo);
SINGLE_ANIMATION(Yetigo);
SINGLE_ANIMATION(Sanctolamb);
SINGLE_ANIMATION(Blockadus);
SINGLE_ANIMATION(Barricadus);
SINGLE_ANIMATION(Raioh);
SINGLE_ANIMATION(Raijin);
SINGLE_ANIMATION(Skullrex);
SINGLE_ANIMATION(Galey);
SINGLE_ANIMATION(Skywing);
SINGLE_ANIMATION(Aerowing);
SINGLE_ANIMATION(Ventowyrm);
SINGLE_ANIMATION(Bluey);
SINGLE_ANIMATION(Bluewing);
SINGLE_ANIMATION(Aquawing);
SINGLE_ANIMATION(Hydrowyrm);
SINGLE_ANIMATION(Ashie);
SINGLE_ANIMATION(Ashwing);
SINGLE_ANIMATION(Scorchwing);
SINGLE_ANIMATION(Pyrowyrm);
SINGLE_ANIMATION(Leafy);
SINGLE_ANIMATION(Leafwing);
SINGLE_ANIMATION(Greenwing);
SINGLE_ANIMATION(Gaiawyrm);
SINGLE_ANIMATION(Bearfist);
SINGLE_ANIMATION(Flamorider);
SINGLE_ANIMATION(Orcow);
SINGLE_ANIMATION(Mechadino);
SINGLE_ANIMATION(Skywolf);
SINGLE_ANIMATION(Angelon);
SINGLE_ANIMATION(Plasmorex);
SINGLE_ANIMATION(Tremorback);
SINGLE_ANIMATION(Dreadwolf);
SINGLE_ANIMATION(Magmawyrm);
SINGLE_ANIMATION(Typhonwyrm);
SINGLE_ANIMATION(Omegawyrm);
SINGLE_ANIMATION(Halochron);
SINGLE_ANIMATION(Guardiron);
SINGLE_ANIMATION(Deletroid);
SINGLE_ANIMATION(Destructor);
SINGLE_ANIMATION(Samurice);
SINGLE_ANIMATION(Snowja);
SINGLE_ANIMATION(Vegikit);
SINGLE_ANIMATION(Vegilynx);
SINGLE_ANIMATION(Vegitiger);
SINGLE_ANIMATION(Minispine);
SINGLE_ANIMATION(Stegospine);
SINGLE_ANIMATION(Stegospike);
SINGLE_ANIMATION(Shadowkit);
SINGLE_ANIMATION(Shadowstalker);
SINGLE_ANIMATION(Mandrapod);
SINGLE_ANIMATION(Mandroot);
SINGLE_ANIMATION(Darkpaw);
SINGLE_ANIMATION(Bloodclaw);
SINGLE_ANIMATION(Pegahoof);
SINGLE_ANIMATION(Pegasion);
SINGLE_ANIMATION(Orbling);
SINGLE_ANIMATION(Kamiwyrm);
SINGLE_ANIMATION(Scorpiode);
SINGLE_ANIMATION(Scorpionix);
SINGLE_ANIMATION(Golgem);
SINGLE_ANIMATION(Golgemios);
SINGLE_ANIMATION(Cyberhound);
SINGLE_ANIMATION(Cyberwyrm);
SINGLE_ANIMATION(Spinoheat);
SINGLE_ANIMATION(Spinoburn);
SINGLE_ANIMATION(Spinoflame);
SINGLE_ANIMATION(Hadepup);
SINGLE_ANIMATION(Hadehound);
SINGLE_ANIMATION(Cryptwing);
SINGLE_ANIMATION(Osiriswyrm);
SINGLE_ANIMATION(Arky);
SINGLE_ANIMATION(Arkwing);
SINGLE_ANIMATION(Darkling);
SINGLE_ANIMATION(Necrodrake);
SINGLE_ANIMATION(Zephys);
SINGLE_ANIMATION(Arborus);
SINGLE_ANIMATION(Dahag);
SINGLE_ANIMATION(Vulcarex);
SINGLE_ANIMATION(Esapid);
SINGLE_ANIMATION(Deucalion);
SINGLE_ANIMATION(Tiamat);
