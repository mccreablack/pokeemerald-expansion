...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_CYCLONE_NOVA] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Cyclone Nova", "Cyclone Nova"),
        .description = COMPOUND_STRING(
            "A powerrful wind attack\n"
            "that boosts team speed."),
    ...
    [MOVE_TIDAL_OBLIVION] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Tidal Oblivn", "Tidal Oblivion"),
        .description = COMPOUND_STRING(
            "A powerful water attack\n"
            "that creates a rainstorm."),
        .effect = EFFECT_MAX_MOVE,
        .power = 120,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_INFERNAL_TEMPEST] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Infrnl Tmpst", "Infernal Tempest"),
        .description = COMPOUND_STRING(
            "A powerrful fire attack\n"
            "that makes it sunny."),
        .effect = EFFECT_MAX_MOVE,
        .power = 120,
        .type = TYPE_FIRE,
    ...
    [MOVE_VERDANT_RUPTURE] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Verdnt Ruptr", "Verdant Rupture"),
        .description = COMPOUND_STRING(
            "A powerrful grass attack\n"
            "that makes it grassy."),
        .effect = EFFECT_MAX_MOVE,
        .power = 120,
        .type = TYPE_GRASS,
        .accuracy = 100,
    ...
    [MOVE_MENTAL_BREAKER] =
    {
        .name = COMPOUND_STRING("MentlBreaker"),
        .description = sCloseCombatDescription,
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_PSYCHIC,
